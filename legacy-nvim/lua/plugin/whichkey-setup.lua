...
local mappings = {
  ...
  ["e"] = { '<cmd>lua require("nvim-tree.api").tree.toggle({ focus = false, find_file = true, })<cr>', "Explorer" },
  ...
  b = {
    name = "Buffer",
    c = { "<cmd>lua require('close_buffers').delete({ type = 'this' })<cr>", "Close" },
    k = { "<cmd>lua require('close_buffers').wipe({ type = 'other' })<cr>", "Close all but current" },
    l = {
